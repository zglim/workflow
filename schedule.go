...
// WithScheduleDeadline sets an absolute record-level deadline on every run triggered by the schedule. See
// WithDeadline for the semantics of a record-level deadline.
